...
def err_screen():
    ...
    sc1.iconbitmap(os.path.join(BASE_DIR, "AMS.ico"))  # Correct icon path
    sc1.title("Warning!!")
...
def TakeImageUI():
    ...
    def take_image():
        ...
        takeImage.TakeImage(
            ...
            message,
            err_screen,
            text_to_speech, # Passing the text_to_speech function
        )
        txt1.delete(0, "end")
        txt2.delete(0, "end")
...
def automatic_attedance():
    automaticAttedance.subjectChoose(text_to_speech)  # Passing the text_to_speech function
...
def view_attendance():
    show_attendance.subjectchoose(text_to_speech) # Passing the text_to_speech function
